...
import AccessTrendsChart from './AccessTrendsChart';
import CertificatePopularityChart from './CertificatePopularityChart';
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab}>
        ...
        <TabsContent value="overview">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
            ...
            <Card>
              <CardContent className="pt-6">
                <div className="flex items-center justify-between">
                  <div className="flex items-center">
                    <div className="mr-2 h-10 w-10 rounded-full bg-gray-100 flex items-center justify-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            <Card>
              <CardHeader>
                <CardTitle className="text-lg">Access Trends</CardTitle>
              </CardHeader>
              <CardContent>
                <AccessTrendsChart data={analyticsData.accessTrends} />
              </CardContent>
            </Card>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <Card>
              <CardHeader>
                <CardTitle className="text-lg">Certificate Popularity</CardTitle>
              </CardHeader>
              <CardContent>
                <CertificatePopularityChart data={analyticsData.certificatePopularity} />
              </CardContent>
            </Card>
