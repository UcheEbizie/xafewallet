/*
  # Enhanced Certificate Sharing Features

  This migration adds:
  1. Additional tracking columns for link and email shares
  2. Performance indexes for certificates and shares
  3. Functions for automatic certificate status updates
  4. View count tracking for shared certificates
*/
